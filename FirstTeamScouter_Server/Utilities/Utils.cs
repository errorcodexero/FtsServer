...
namespace FirstTeamScouter_Server
{
    class Utils
    {
        ...
        {
            string csKey = (Program.TEST_MODE) ? "FirstTeamScouter_Server.Properties.Settings.FTS_TEST_ConnectionString" : "FirstTeamScouter_Server.Properties.Settings.FTS_ConnectionString";
